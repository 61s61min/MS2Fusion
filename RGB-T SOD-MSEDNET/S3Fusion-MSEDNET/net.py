...
class S3F_Net(nn.Module):
    def __init__(self):
        super(S3F_Net, self).__init__()
        (
            self.layer1_rgb,
            self.layer2_rgb,
            self.layer3_rgb,
    ...
    def forward(self, rgb, ir):
        ...
        feat1.append(x1)
        feat1.append(ir1)
        out5 = self.SSF5(feat5)
        out4 = self.SSF4(feat4)
        out3 = self.SSF3(feat3)
        out2 = self.SSF2(feat2)
        out1 = self.SSF1(feat1)

        return self.decoder(out5, out4, out3, out2, out1)


class IDAF_Net(nn.Module):
    def __init__(self):
        super(IDAF_Net, self).__init__()
        (
            self.layer1_rgb,
            self.layer2_rgb,
            self.layer3_rgb,
        ...
        # self.SCA2 = SCA(128)
        # self.EDS1 = EDS(64)
        self.idaf5 = Iterative_Differential_TransformerFusionBlock(512,5,5)
        self.idaf4 = Iterative_Differential_TransformerFusionBlock(256,5,5)
        self.idaf3 = Iterative_Differential_TransformerFusionBlock(256,10,10)
        self.idaf2 = Iterative_Differential_TransformerFusionBlock(128,20,20)
        self.idaf1 = Iterative_Differential_TransformerFusionBlock(64,40,40)
    ...
    def forward(self, rgb, ir):
        ...
        ir4 = self.rgbconv4(ir4)
        ir5 = self.rgbconv5(ir5)
        out5 = self.idaf5(x5,ir5)
        out4 = self.idaf4(x4,ir4)
        out3 = self.idaf3(x3,ir3)
        out2 = self.idaf2(x2,ir2)
        out1 = self.idaf1(x1,ir1)
