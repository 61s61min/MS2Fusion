...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/ssf/M3FD/yolov5l_share_SSF_M3FD.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/multispectral/M3FD.yaml', help='data.yaml path')
    ...
    parser.add_argument('--project', default='runs/train/M3FD', help='save to project/name')
    parser.add_argument('--entity', default=None, help='W&B entity')
    parser.add_argument('--name', default='yolov5l_share_SSF_M3FD', help='save to project/name')
