...
parser.add_argument('--output-dir', type=str, default='visualization/FLIR-align-3class/car/SSF', help='output dir')
...
parser.add_argument('--choose_names', type=str, default='car', help='class to show')
#'person, car, bicycle'
