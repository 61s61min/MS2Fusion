...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/M3FD/yolov5l_share_SSF_M3FD/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/home/shen2/dataset_zhb/M3FD_Detection/visible/test/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/shen2/dataset_zhb/M3FD_Detection/infrared/test/', help='source')  # file/folder, 0 for webcam
